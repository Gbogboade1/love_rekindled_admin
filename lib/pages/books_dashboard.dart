...
import 'package:love_rekindled_admin/pages/book_preview.dart';
import 'package:love_rekindled_admin/pages/books_editor.dart';
import 'package:love_rekindled_admin/ui_items/general_ui_item.dart';

class BooksDashboardPage extends StatefulWidget {
  @override
  _BooksDashboardPageState createState() => _BooksDashboardPageState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: InkWell(
        onTap: () {
          pushRoute(context, BooksEditorPage());
        },
        child: Card(
          child: Padding(
                                  ...
                                  return InkWell(
                                    onTap: () {
                                      Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (c) => BookPreviewPage(churchItem: item,)));
                                    },
